 ...
 * @brief   Values must be configured by the user - Master
...
#define BREWCONTROL_TYPE      1                       // 0 = off (no brewing control), 1 = Brew by time (with preinfusion), 2 = Brew by weight (from scale)
#define FEATURE_BREWDETECTION 1                       // 0 = deactivated, 1 = activated
#define BREWDETECTION_TYPE    2                       // 1 = Software (BREWCONTROL_TYPE 0), 2 = Hardware BREWCONTROL_TYPE 1 or 2, 3 = optocoupler for BREWCONTROL_TYPE 0
